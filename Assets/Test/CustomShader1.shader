	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 vertexPos8 = float4( IN.ase_texcoord7.xyz , 0.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 vertexPos8 = float4( IN.ase_texcoord2.xyz , 0.0 );
				float noise8 = _Vector0.x;
				float roughness8 = _Vector0.y;
				float ssprUsage8 = _Vector0.z;
				float3 localHam18 = Ham1( vertexPos8 , noise8 , roughness8 , ssprUsage8 );
...
/*ASEBEGIN
Version=18900
907.2;840;1172.8;646.2;953.298;294.8163;1;True;False
Node;AmplifyShaderEditor.PosVertexDataNode;9;-570.3436,-23.05524;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;11;-579.8275,137.4695;Inherit;False;Property;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;7;-296.4,-122.5;Inherit;False;Property;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.7264151,0.7264151,0.7264151,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CustomExpressionNode;8;-354.3132,76.19019;Inherit;False;                ReflectionInput reflectionData@$                reflectionData.posWS = TransformObjectToWorld(vertexPos.xyz)@$                reflectionData.screenPos = ComputeScreenPos(vertexPos)@$                reflectionData.screenSpaceNoise = noise@$                reflectionData.roughness = roughness@$                reflectionData.SSPR_Usage = ssprUsage@$return GetResultReflection(reflectionData)@$$                half3 resultReflection = GetResultReflection(reflectionData)@;3;False;4;True;vertexPos;FLOAT4;0,0,0,0;In;;Float;False;True;noise;FLOAT;0;In;;Inherit;False;True;roughness;FLOAT;0;In;;Inherit;False;True;ssprUsage;FLOAT;0;In;;Inherit;False;Ham1;False;False;0;4;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=95A7F730AEFE53ECF27398F6BF70DAC513EC7CBE