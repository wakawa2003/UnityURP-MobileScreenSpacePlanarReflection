...
Shader "CustomShader1"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_Vector0("Vector 0", Vector) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 Ham1( float4 vertexPos, float noise, float roughness, float ssprUsage )
			{
				                ReflectionInput reflectionData;
				                reflectionData.posWS = TransformObjectToWorld(vertexPos.xyz);
				                reflectionData.screenPos = ComputeScreenPos(vertexPos);
				                reflectionData.screenSpaceNoise = noise;
				                reflectionData.roughness = roughness;
				                reflectionData.SSPR_Usage = ssprUsage;
				return GetResultReflection(reflectionData);
			}
						 ...
						 ) : SV_Target
			{
				...
				float3 objToWorld24 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord7.xyz, 1 ) ).xyz;
				float4 vertexPos8 = float4( objToWorld24 , 0.0 );
				float noise8 = _Vector0.x;
				float roughness8 = _Vector0.y;
				float ssprUsage8 = _Vector0.z;
				float3 localHam18 = Ham1( vertexPos8 , noise8 , roughness8 , ssprUsage8 );
				
				float3 Albedo = localHam18;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 objToWorld24 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord2.xyz, 1 ) ).xyz;
				float4 vertexPos8 = float4( objToWorld24 , 0.0 );
				float noise8 = _Vector0.x;
				float roughness8 = _Vector0.y;
				float ssprUsage8 = _Vector0.z;
...
/*ASEBEGIN
Version=18900
319.2;541.6;1461.6;500.6;1385.815;308.7625;1.3;True;False
Node;AmplifyShaderEditor.TexCoordVertexDataNode;22;-755.3357,-161.3204;Inherit;True;0;3;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;11;-586.8275,115.4695;Inherit;False;Property;_Vector0;Vector 0;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TransformPositionNode;24;-496.6149,-131.9625;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.CustomExpressionNode;8;-255.4806,32.7472;Inherit;False;                ReflectionInput reflectionData@$                reflectionData.posWS = TransformObjectToWorld(vertexPos.xyz)@$                reflectionData.screenPos = ComputeScreenPos(vertexPos)@$                reflectionData.screenSpaceNoise = noise@$                reflectionData.roughness = roughness@$                reflectionData.SSPR_Usage = ssprUsage@$return GetResultReflection(reflectionData)@;3;False;4;True;vertexPos;FLOAT4;0,0,0,0;In;;Float;False;True;noise;FLOAT;0;In;;Inherit;False;True;roughness;FLOAT;0;In;;Inherit;False;True;ssprUsage;FLOAT;0;In;;Inherit;False;Ham1;False;False;0;4;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;CustomShader1;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;2;Include;;False;;Native;Include;Assets/_MobileSSPR/ReusableCore/MobileSSPRInclude.hlsl;False;;Custom;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=7BA4D09BF3ABC26FAD093425097D0B7490E6756B